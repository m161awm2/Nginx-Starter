...
[cite_start]이 프로젝트는 리눅스 환경에서의 **Nginx 자동 설치**, **파이썬 기반 로그 관리**, 그리고 **Docker 컨테이너화**를 한 번에 해결하기 위한 통합 패키지입니다. [cite: 1]
...
| 파일명 | 역할 설명 |
| :--- | :--- |
| **index.html** | [cite_start]서버 구축 완료 시 보여질 기본 웹 페이지입니다. [cite: 1] |
